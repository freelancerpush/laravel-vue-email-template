...
var app = new Vue({
  ...
  methods: {
    ...
    setVal: function setVal(val_id, val_name, val_subject, val_description) {
      this.e_id = val_id;
    ...
    editItem: function editItem() {
      ...
      var s_val_1 = document.getElementById('e_subject'); //var d_val_1 = document.getElementById('e_description');
  ...
  computed: {
    subjectLength: function subjectLength() {
      // `this` points to the vm instance
      return this.selected_template_subject.length;
    },
    descriptionWordCount: function descriptionWordCount() {
      var descriptionCount = this.selected_template_description.trim();
    ...
    questionWordCount: function questionWordCount() {
      return this.selected_template_description.split('?').length - 1;
    },
    spamWordCount: function spamWordCount() {
      var _this3 = this;

      var currentDescription = this.selected_template_description.replace(/\r?\n|\r/g, " ");
      currentDescription = this.html2text(currentDescription);
      var currentDescriptionArray = currentDescription.split(" ");
      var resultMatch = [];
      var spamCount = 0;

      var _loop = function _loop(i) {
        var out = currentDescriptionArray.filter(function (word) {
          return word == _this3.spamitems[i];
        });
      ...
      for (var i = 0; i < this.spamitems.length; i++) {
        _loop(i);
      }
...
__webpack_require__(/*! /Applications/MAMP/htdocs/lara-vue/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/lara-vue/resources/sass/app.scss */"./resources/sass/app.scss");
